...
def index():
    ...
    host_port = loadbalancer_dns_name + ':' + https_listen_port
    ...
    if index_id is False:
        ...
        user_kibana_url = "https://" + host_port + "/_plugin/kibana/"
    else:
        user_kibana_url = "https://"+host_port+"/_plugin/kibana/app/kibana#/discover?_g=(filters:!(),refreshInterval:(pause:!t,value:0),time:(from:'"+start+"T00:00:00.000Z',to:'"+end+"T23:59:59.000Z'))&_a=(columns:!(_source),filters:!(),index:'"+index_id+"',interval:auto,query:(language:kuery,query:'user:"+user+"'),sort:!(!(start_iso,desc)))"
